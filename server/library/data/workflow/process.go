...
func (p *_process) Init() error {
	var processes = []model.WorkflowProcess{
		{ID: "leaveFlow", CreateTime: time.Now(), UpdateTime: time.Now(), Name: "leaveFlow", Clazz: "process", Label: system.I18nHash["LeaveProcess"], HideIcon: false, Description: system.I18nHash["LeaveProcess"], View: "view/iconList/index.vue"},
	}
