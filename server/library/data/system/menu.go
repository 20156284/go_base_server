...
func (m *menu) Init() error {
	menus := []model.Menu{
		...
		{Model: global.Model{ID: 22, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "https://github.com/20156284/go_base_server", Name: "https://github.com/20156284/go_base_server", Hidden: false, Component: "/", Sort: 0, Meta: model.Meta{Title: I18nHash["OfficialWebsite"], Icon: "s-home"}},
